...
import { Button, Typography, Card, Col, Input, Row, Alert } from "antd";
...
let ModifyPresentComponent = (props) => {
    ...
    let clickModify= async() => {
        ...
        if(response.ok){
            createNotification("success","Present modifyed")
            navigate("/presents")
        ...
        <Row align="middle" justify="center" style={{minHeight: "70vh"}}>
            ...
            {message !="" && <Alert type="error" message={message}/>}
                <Card title="Modify present" style={{minWidth: "300px", maxWidth:"500px", textAlign:"center"}}>
                    ...
                    <Button type="primary"  onClick={clickModify} >Save changes</Button>
